...
<div class="container apresentation-container">
    ...
    <div class="row wow bounceInUp mb-5">
        <div class="col-md-3">
            <div class="col-md-12 mb-5" id="textApresentation">
                <h1 class="mb-5">Manage. Live. Enjoy</h1>
                Enjoy, we care of your time
            </div>
            <div class="col-md-12 mb-5">
                <button class="button-primary-everest">Instalar</button>
            </div>
        ...
        <div class="col-md-6 wow bounceInUp d-flex justify-content-center align-center mb-5">
            <img src="../web/images/undraw_reminder_u6i7.svg" width="400px" alt="Manager You Time">
        </div>
    </div>
</div>
<!-- FIRST CONTAINER -->
